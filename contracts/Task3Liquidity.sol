...
contract Task3Liquidity is ExamBase {
        ...
        returns (int256 amount0, int256 amount1)
    {
        ...
        require(tickNow % TICK_SPACING != 0, "a tick is not a multiple of the tick spacing");
        ...
        require(tickNow >= tickLower /* replace: tickNow is not below tickLower */, "the live tick is below your range");
        require(tickNow < tickUpper /* replace: tickNow is strictly below tickUpper */, "the live tick is at or above your range");
